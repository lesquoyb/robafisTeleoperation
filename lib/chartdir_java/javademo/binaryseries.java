...
public class binaryseries implements DemoModule
{
    ...
    public void createChart(ChartViewer viewer, int chartIndex)
    {
        ...
        Date[] dataX = {new GregorianCalendar(2008, 6, 1, 0, 0, 0).getTime(), new GregorianCalendar(
            2008, 6, 1, 2, 17, 2).getTime(), new GregorianCalendar(2008, 6, 1, 8, 5, 30).getTime(),
            new GregorianCalendar(2008, 6, 1, 10, 54, 10).getTime(), new GregorianCalendar(2008, 6,
            1, 15, 40, 0).getTime(), new GregorianCalendar(2008, 6, 1, 18, 22, 20).getTime(),
            new GregorianCalendar(2008, 6, 1, 22, 17, 14).getTime(), new GregorianCalendar(2008, 6,
            2, 2, 55, 50).getTime(), new GregorianCalendar(2008, 6, 2, 8, 17, 14).getTime(),
            new GregorianCalendar(2008, 6, 2, 11, 55, 50).getTime(), new GregorianCalendar(2008, 6,
            2, 13, 17, 14).getTime(), new GregorianCalendar(2008, 6, 2, 17, 55, 50).getTime(),
            new GregorianCalendar(2008, 6, 2, 20, 17, 14).getTime(), new GregorianCalendar(2008, 6,
            3, 0, 0, 0).getTime()};
        ...
        // border. Use grey (888888) solid line and light grey (ccccc) dotted line as major and
        ...
        //
        // To perform ON/OFF filling, we draw the logic line, and its reverse, and fill the region
        // in between
        //
