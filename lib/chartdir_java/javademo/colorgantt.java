...
public class colorgantt implements DemoModule
{
    ...
    public void createChart(ChartViewer viewer, int chartIndex)
    {
        ...
        Date[] startDate = {new GregorianCalendar(2004, 7, 16).getTime(), new GregorianCalendar(
            2004, 9, 4).getTime(), new GregorianCalendar(2004, 7, 30).getTime(),
            new GregorianCalendar(2004, 8, 13).getTime(), new GregorianCalendar(2004, 8, 20
            ).getTime(), new GregorianCalendar(2004, 8, 27).getTime(), new GregorianCalendar(2004,
            9, 4).getTime(), new GregorianCalendar(2004, 9, 4).getTime(), new GregorianCalendar(
            2004, 9, 25).getTime(), new GregorianCalendar(2004, 10, 1).getTime(),
            new GregorianCalendar(2004, 9, 18).getTime(), new GregorianCalendar(2004, 10, 8
            ).getTime()};
        Date[] endDate = {new GregorianCalendar(2004, 7, 30).getTime(), new GregorianCalendar(2004,
            9, 18).getTime(), new GregorianCalendar(2004, 8, 13).getTime(), new GregorianCalendar(
            2004, 8, 27).getTime(), new GregorianCalendar(2004, 9, 4).getTime(),
            new GregorianCalendar(2004, 9, 11).getTime(), new GregorianCalendar(2004, 10, 8
            ).getTime(), new GregorianCalendar(2004, 9, 18).getTime(), new GregorianCalendar(2004,
            10, 8).getTime(), new GregorianCalendar(2004, 10, 22).getTime(), new GregorianCalendar(
            2004, 10, 1).getTime(), new GregorianCalendar(2004, 10, 22).getTime()};
        ...
        // 7 days (1 week)
        c.yAxis().setDateScale(new GregorianCalendar(2004, 7, 16).getTime(), new GregorianCalendar(
            2004, 10, 22).getTime(), 86400 * 7);
        ...
        c.addScatterLayer(new double[]{1}, Chart.CTime(new Date[]{new GregorianCalendar(2004, 8, 13
            ).getTime()}), "Milestone 1", Chart.Cross2Shape(), 13, 0xffff00).setHTMLImageMap(
            "{disable}");
        c.addScatterLayer(new double[]{3}, Chart.CTime(new Date[]{new GregorianCalendar(2004, 9, 4
            ).getTime()}), "Milestone 2", Chart.StarShape(5), 15, 0xff00ff).setHTMLImageMap(
            "{disable}");
        c.addScatterLayer(new double[]{5}, Chart.CTime(new Date[]{new GregorianCalendar(2004, 10, 8
            ).getTime()}), "Milestone 3", Chart.TriangleSymbol, 13, 0xff9933).setHTMLImageMap(
            "{disable}");
