...
public class xzonecolor implements DemoModule
{
    ...
    public void createChart(ChartViewer viewer, int chartIndex)
    {
        ...
        Date[] labels = {new GregorianCalendar(2001, 0, 1).getTime(), new GregorianCalendar(2001, 1,
            1).getTime(), new GregorianCalendar(2001, 2, 1).getTime(), new GregorianCalendar(2001,
            3, 1).getTime(), new GregorianCalendar(2001, 4, 1).getTime(), new GregorianCalendar(
            2001, 5, 1).getTime(), new GregorianCalendar(2001, 6, 1).getTime(),
            new GregorianCalendar(2001, 7, 1).getTime(), new GregorianCalendar(2001, 8, 1).getTime(
            ), new GregorianCalendar(2001, 9, 1).getTime(), new GregorianCalendar(2001, 10, 1
            ).getTime(), new GregorianCalendar(2001, 11, 1).getTime(), new GregorianCalendar(2002,
            0, 1).getTime(), new GregorianCalendar(2002, 1, 1).getTime(), new GregorianCalendar(
            2002, 2, 1).getTime(), new GregorianCalendar(2002, 3, 1).getTime(),
            new GregorianCalendar(2002, 4, 1).getTime(), new GregorianCalendar(2002, 5, 1).getTime(
            ), new GregorianCalendar(2002, 6, 1).getTime(), new GregorianCalendar(2002, 7, 1
            ).getTime(), new GregorianCalendar(2002, 8, 1).getTime(), new GregorianCalendar(2002, 9,
            1).getTime(), new GregorianCalendar(2002, 10, 1).getTime(), new GregorianCalendar(2002,
